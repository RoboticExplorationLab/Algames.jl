...
struct IntersectionScenario{T} <:Scenario{T}
    ...
    actors_radii::Vector{Vector{T}} # radii of the actors
...
struct TIntersectionScenario{T} <: Scenario{T}
    ...
    actors_radii::Vector{Vector{T}} # radii of the actors (cars, pedestrians)
    actors_types::Vector{Symbol} # type of the actors
...
struct MergingScenario{T} <: Scenario{T}
    ...
    actors_radii::Vector{Vector{T}} # radii of the actors (cars)
    actors_types::Vector{Symbol} # type of the actors
end
