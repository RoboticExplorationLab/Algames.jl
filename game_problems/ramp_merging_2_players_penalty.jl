...
ramp_length = 17.2
ramp_angle = pi/12
ramp_merging_2_players_penalty_scenario = MergingScenario(road_length,
...
add_scenario_constraints(algames_conSet, ramp_merging_2_players_penalty_scenario,
	px, con_inds; constraint_type=:constraint)

algames_ramp_merging_2_players_penalty_prob = GameProblem(model, obj, xf, tf,
	constraints=algames_conSet, x0=x0, N=N)

algames_ramp_merging_2_players_penalty_opts = DirectGamesSolverOptions{T}(
    iterations=10,
    inner_iterations=20,
...
algames_ramp_merging_2_players_penalty_solver =
	DirectGamesSolver(
	algames_ramp_merging_2_players_penalty_prob,
	algames_ramp_merging_2_players_penalty_opts)

# add penalty constraints
add_collision_avoidance(algames_ramp_merging_2_players_penalty_solver.penalty_constraints,
    inflated_actors_radii, px, p, con_inds; constraint_type=:constraint)

reset!(algames_ramp_merging_2_players_penalty_solver, reset_type=:full)
algames_ramp_merging_2_players_penalty_contraints = copy(algames_ramp_merging_2_players_penalty_solver.penalty_constraints)
