...
algames_t_intersection_3_players_opts = DirectGamesSolverOptions{T}(
    iterations=10,
    inner_iterations=20,
    iterations_linesearch=10,
    min_steps_per_iteration=0,
    log_level=TO.Logging.Warn)
algames_t_intersection_3_players_solver = DirectGamesSolver(algames_t_intersection_3_players_prob, algames_t_intersection_3_players_opts)

ilqgames_t_intersection_3_players_opts = PenaltyiLQGamesSolverOptions{T}(
    iterations=200,
...
ilqgames_t_intersection_3_players_solver = PenaltyiLQGamesSolver(ilqgames_t_intersection_3_players_prob, ilqgames_t_intersection_3_players_opts)
