...
ramp_length = 3.2
ramp_angle = pi/12
ramp_merging_2_players_mpc_scenario = MergingScenario(road_length, road_width, ramp_length,
...
add_scenario_constraints(algames_conSet, ramp_merging_2_players_mpc_scenario, px, con_inds; constraint_type=:constraint)
...
# vis, anim = animation(mpc_solver, ramp_merging_2_players_mpc_scenario;
# 	vis=vis, anim=anim,
# 	open_vis=false,
# 	display_actors=true,
