...
ramp_length = 3.2
ramp_angle = pi/12
ramp_merging_2_players_scenario = MergingScenario(road_length, road_width, ramp_length, ramp_angle, actors_radii, actors_types)
...
add_scenario_constraints(algames_conSet, ramp_merging_2_players_scenario, px, con_inds; constraint_type=:constraint)
add_scenario_constraints(ilqgames_conSet, ramp_merging_2_players_scenario, px, con_inds; constraint_type=:constraint)
...
algames_ramp_merging_2_players_opts = DirectGamesSolverOptions{T}(
    iterations=10,
    inner_iterations=20,
    iterations_linesearch=10,
    min_steps_per_iteration=1,
    log_level=TO.Logging.Debug)
algames_ramp_merging_2_players_solver = DirectGamesSolver(algames_ramp_merging_2_players_prob, algames_ramp_merging_2_players_opts)

ilqgames_ramp_merging_2_players_opts = PenaltyiLQGamesSolverOptions{T}(
    iterations=200,
...
ilqgames_ramp_merging_2_players_solver = PenaltyiLQGamesSolver(ilqgames_ramp_merging_2_players_prob, ilqgames_ramp_merging_2_players_opts)
