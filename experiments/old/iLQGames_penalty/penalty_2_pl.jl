...
#                -1.00,  0.10,  0.00,  0.00, #lane1 player 2 goes first
#                -1.00, -0.10,  0.00,  0.00, #lane2 player 2 goes first
...
x0 = @SVector [
               # -1.00,  0.10,  0.90,  0.00, #lane1 player 1 goes first
               # -1.00, -0.10,  1.10,  0.00, #lane2 player 1 goes first
               -1.00,  0.10,  0.90,  0.00, #lane1 player 2 goes first
               -1.00, -0.10,  1.10,  0.00, #lane2 player 2 goes first
               # -1.00,  0.10,  1.10,  0.00, #lane1 player 2 goes first
               #  1.00, -0.10, -0.90,  0.00, #lane2 player 2 goes first
                ]
xf = @SVector [
...
for i = 1:p
    for j = 1:i-1
        ...
        add_constraint!(conSet, col_con, 1:N)
    end
end
...
# obs = [1.0, -0.10]
obs = [0.0, -0.20]
scenario = StraightScenario(road_length, road_width, car_radii, obs_radius, obs)
