...
l2 = 1.0
# obs_radius = 0.4/10.
obs_radius = 20.0/10. - car_radius
# obs = [0.50, -0.12]
# obs = [0.70, -0.12]
obs = [1.0, -0.10]
scenario = StraightScenario(l1, l2, car_radii, obs_radius, obs)
add_scenario_constraints(conSet, scenario, plx, N, n; constraint_type=:penalty)
...
pen = ones(length(solver_penalty.constraints))*1.0
...
visualize_trajectory_car(solver_penalty,pl,plx,car_radius,l1)
