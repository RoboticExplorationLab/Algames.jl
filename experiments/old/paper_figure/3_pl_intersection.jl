...
@btime $solver_directgames.state_view_H[$i][$k-1] .= $∇ci'*$Iμ*$∇c # Best
@btime $solver_directgames.state_view_H[$i][$k-1] .=  $solver_directgames.state_view_H[$i][$k-1] .+ $∇ci'*$Iμ*$∇c # Best
