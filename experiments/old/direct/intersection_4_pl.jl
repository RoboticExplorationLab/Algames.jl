...
Base.size(::DoubleIntegratorGame) = 16,8,[[1,2],[3,4],[5,6],[7,8]],4
...
function dynamics(model::DoubleIntegratorGame, x, u)
    ...
    control4 = @SVector [u[pl_ind] for pl_ind in pl[4]]
    qdd1 = control1/mp
    qdd2 = control2/mp
    qdd3 = control3/mp
    qdd4 = control4/mp
...
x0 = @SVector [
               -0.15,  0.3,   0.0, -1.0, #lane1
                ...
                0.15, -0.5,   0.0,  1.0, #lane3
               -0.9,  -0.15,  1.0,  0.0, #lane4
                ]
xf = @SVector [
                0.6,  -0.15, 0.0, 0.0, #lane1
               -0.15, -0.50, 0.0, 0.0, #lane2
               -0.4 ,  0.15, 0.0, 0.0, #lane3
                # 0.15 , -0.5, 0.0, 0.0, #lane3
               # -0.15 ,  0.3,  0.0, 0.0,#lane4
                0.15,  0.20,  0.0, 0.0,#lane4
               ]
...
using Plots
visualize_trajectory_car(solver_directgames,X,U/20,pl,plx,car_radius,l1)
...
visualize_trajectory_car(solver_directgames,X,U/5,pl,plx,car_radius,l1)
