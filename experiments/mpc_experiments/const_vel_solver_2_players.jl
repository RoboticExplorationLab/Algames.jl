...
for i = 1:p
	...
	add_scenario_constraints(algames_conSet[i], ramp_merging_2_players_unicycle_penalty_scenario,
...
algames_probs = [GameProblem(model, obj, xf, tf,
...
const_vel_solvers = [DirectGamesSolver(algames_probs[i], algames_opts) for i=1:p]
