...
AG.reset!(algames_ramp_merging_2_players_unicycle_penalty_solver, reset_type=:full)
...
@time timing_solve(algames_ramp_merging_2_players_unicycle_penalty_solver)
visualize_trajectory_car(algames_ramp_merging_2_players_unicycle_penalty_solver)
...
vis, anim = animation(algames_ramp_merging_2_players_unicycle_penalty_solver,
