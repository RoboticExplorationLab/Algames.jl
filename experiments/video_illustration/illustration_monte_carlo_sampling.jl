...
inflated_actors_radii = [2.0*actor_radius for i=1:p]
...
opts_monte_carlo = MonteCarloSamplerOptions{n,T}(
    ...
    iterations=11) # number of Monte Carlo samples
...
vis, anim = animation(algames_sampler.solver,
	scenario;
	vis=vis, anim=anim,
	open_vis=false,
	display_actors=true,
