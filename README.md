...
The experiments are available [here](https://github.com/RoboticExplorationLab/AlgamesDriving.jl/releases/tag/autonomous_robots_v1.0).
...
## Quick Start
To run a simple example of a dynamic game see script in /examples/intro_example.jl. For autonomous driving examples see [AlgamesDriving.jl](https://github.com/RoboticExplorationLab/AlgamesDriving.jl).
